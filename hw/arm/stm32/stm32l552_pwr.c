...
#define PWR_TRACE(fmt, ...) fprintf(stderr, "stm32l552_pwr: " fmt, ##__VA_ARGS__)
#define PWR_ERROR(fmt, ...) fprintf(stderr, "stm32l552_pwr: ERROR: " fmt, ##__VA_ARGS__)
...
static void stm32l552_pwr_write(void *opaque, hwaddr addr, uint64_t val64, unsigned int size){
    struct stm32l552_pwr *self = (struct stm32l552_pwr*)opaque;
    if(size > 4){
...
static const MemoryRegionOps stm32l552_pwr_ops = {
    .read = stm32l552_pwr_read,
    .write = stm32l552_pwr_write,
    .endianness = DEVICE_NATIVE_ENDIAN
};

static void stm32l552_pwr_init(Object *obj){
    struct stm32l552_pwr *self = OBJECT_CHECK(struct stm32l552_pwr, obj, TYPE_STM32L552_PWR);
    sysbus_init_irq(SYS_BUS_DEVICE(obj), &self->irq);
    memory_region_init_io(&self->mmio, obj, &stm32l552_pwr_ops, self, TYPE_STM32L552_PWR, 0x100);
    sysbus_init_mmio(SYS_BUS_DEVICE(obj), &self->mmio);
}

static void stm32l552_pwr_reset(DeviceState *dev){
    struct stm32l552_pwr *self = OBJECT_CHECK(struct stm32l552_pwr, dev, TYPE_STM32L552_PWR);
...
static void stm32l552_pwr_realize(DeviceState *dev, Error **errp){
    stm32l552_pwr_reset(dev);
}

static Property stm32l552_pwr_properties[] = {
    //DEFINE_PROP("state", struct stm32l552_pwr, state, qdev_prop_ptr, struct stm32l552_state*),
    DEFINE_PROP_END_OF_LIST()
};

static void stm32l552_pwr_class_init(ObjectClass *klass, void *data){
    DeviceClass *dc = DEVICE_CLASS(klass);
    dc->reset = stm32l552_pwr_reset;
    dc->props_ = stm32l552_pwr_properties;
    dc->realize = stm32l552_pwr_realize;
}

static const TypeInfo stm32l552_pwr_info = {
    .name          = TYPE_STM32L552_PWR,
    .parent        = TYPE_SYS_BUS_DEVICE,
    .instance_size = sizeof(struct stm32l552_pwr),
    .instance_init = stm32l552_pwr_init,
    .class_init    = stm32l552_pwr_class_init
};

static void stm32l552_pwr_register_types(void){
    type_register_static(&stm32l552_pwr_info);
}

type_init(stm32l552_pwr_register_types)
